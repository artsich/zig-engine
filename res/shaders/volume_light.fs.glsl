...
void main() {
    ...
    // Затухание с учетом радиуса источника света
    // float radiusAttenuation = 1.0 - (lightDistance / radius);
    // radiusAttenuation = max(radiusAttenuation, 0.0); // Обеспечивает, что attenuation >= 0
